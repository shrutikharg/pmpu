<?php
class Admin_companyuserprofile extends CI_Controller {
    ...
    public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                if($this->companycourses_model->store_courses($data_to_store)){
    ...
    */
    public function delete()
    {
        //product id 
        $id = $this->uri->segment(4);
        $this->companycourses_model->delete_courses($id);
