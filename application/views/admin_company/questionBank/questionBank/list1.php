...
<ul class="page-stats">
     ...
     <table id="sequence_table" class="table table-bordered pagin-table">
        ...
        <tbody>
            ...
            <td><a href="" ><img src="../assets/assets/img/Add question_1.png"  /></a>
              	&nbsp;
              <a href="" ><img src="../assets/assets/img/Add List_1.png"   /></a>	
              &nbsp;
...
<div class="form-group">									
										...
										<div class="col-md-7"><input type="text" name="answers[]" class="form-control txt_input" id=""   data-rule-required="true" >
...
<div class="form-group">								
										...
										<label class="col-md-3 control-label"></label>
										<div class="col-md-7">
								<img class="add_button" src="../assets/assets/img/Add_1.png"  />
...
<div class="form-group">
										...
										<label class="col-md-3 control-label control_lbl">Question Bank Name</label>
										<div class="col-md-7"><input type="text" class="form-control txt_input" id="" name="name"  data-rule-required="true" >
...
$(document).ready(function(){
	...
	var fieldHTML = '<div style="clear:both;" class="form-group"><label class="col-md-3 control-label"></label><div class="col-md-7"><input type="text" name="answers[]" class="form-control txt_input" id=""   data-rule-required="true" ><img class="remove_button" src="../assets/assets/img/Remove_1.png"  /></div></div>'; 
