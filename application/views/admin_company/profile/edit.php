										...
										<div class="row profile-info">
											<div class="col-md-7">
												<dl class="dl-horizontal">
													<dt>Name</dt>
													<dd><?php echo $users->first_name.' '.$users->last_name; ?></dd> <br>
													<dt>Email-Id</dt>
													<dd><?php echo $users->email; ?></dd> <br>
													<!--<dt>Alternate Email-Id</dt>
													<dd>harshad25@gmail.com</dd><br>-->
													<dt>Mobile No.</dt>
													<dd>+91 <?php echo $users->phone_no ?></dd>
												</dl>
											</div>
										</div> <!-- /.row -->
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8"><input type="text" name="user_fname" id="user_fname" class="form-control" value="<?php echo $users->first_name;?>" readonly="true"></div>
															</div>

															<div class="form-group">
																<label class="col-md-4 control-label">Last name:</label>
																<div class="col-md-8"><input type="text" name="user_lname" id="user_lname" class="form-control" value="<?php echo $users->last_name;?>" readonly="true"></div>
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8"><input type="email" name="user_email" id="user_email" class="form-control" value="<?php echo $users->email;?>" readonly="true"></div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-md-8"><input type="text" name="umobile" id="umobile" class="form-control" value="<?php echo $users->phone_no; ?>"></div>
															</div>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8"><input type="text" name="user_type" id="user_type" class="form-control" value="<?php echo $users->name; ?>" readonly="true"></div>
															</div>
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8"><input type="text" name="plan" id="plan" class="form-control" value="<?php echo $users->hostingplan_name; ?>" readonly="true"></div>
															</div>
