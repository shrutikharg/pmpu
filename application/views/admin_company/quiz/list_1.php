<script>var is_search = false, page = 1, search_string_array = "";
    ...
    $(document).ready(function () {
        ...
        function edit_category(category_id){  
            ...
            $(form).attr("action", "../admin_company/quiz/add");
    ...
    function fetch_list(page) {
        ...
        $.ajax({
            ...
            \n\<div class='column' data-label='Quiz Questions'>" + row['no_of_attempt'] + "<a href='<?php echo base_url(); ?>admin_company/quiz/addQuestion' class='btn btn-xs bg-maroon'> Manage</a></div>\n\
