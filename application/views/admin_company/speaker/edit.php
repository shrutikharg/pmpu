            ...
            <div class="col-md-12">
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content">
                        ...
                        echo form_open_multipart('admin_company/speaker/update', $attributes);
                        ?>

                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo $this->lang->line('lbl_speaker'); ?></label>
                            <div class="col-md-10"><input type="text" class="form-control" id="name" name="name" placeholder="<?php echo $this->lang->line('lbl_speaker'); ?>"  value="<?php echo $speaker[0]['name']; ?>" /></div>
                        </div>
                           <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo $this->lang->line('lbl_speaker_designation'); ?></label>
                            <div class="col-md-10"><input type="text" class="form-control" id="designation" name="designation" placeholder="<?php echo $this->lang->line('lbl_speaker_designation'); ?>"  data-rule-required="true"  data-msg-required="Please enter course name." value="<?php echo $speaker[0]['designation']; ?>" /></div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo $this->lang->line('lbl_speaker_desc'); ?></label>
                            <div class="col-md-10"><textarea class="form-control"  name="description" placeholder="<?php echo $this->lang->line('lbl_speaker_desc'); ?>" cols="5" rows="3"><?php echo $speaker[0]['description']; ?></textarea></div>
                        </div>
                        ...
                        <div class="form-group" style="display:none;">
                            <div class="col-md-10"><input type="text"  name="speaker_id" class="form-control" value="<?php echo $speaker_id; ?>" ></div>
                        ...
                        <div class="form-actions">	
                            ...
                            <a href="../speaker/">   <button  class="btn btn-primary"><?php echo $this->lang->line('btn_cancel'); ?></a>
