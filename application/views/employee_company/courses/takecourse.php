...
var a="<?php echo $chaptertake[0]['file_name']; ?>"; 
                            ...
                            window.onbeforeunload = function (event) {
                                ...
                                if (event) {
                                    ...
                                    if (!(jQuery.isEmptyObject(chapter_user_slide_details_array))) {console.log(chapter_user_slide_details_array);
                                        ...
                                        $.ajax({
                                            type: "post",
                                            url: "../../course_details/store_user_slide_details_array/"+<?php echo $chaptertake[0]['chapterid'];?>,
                                            dataType: "text",
                        ...
                        function get_value(cmi_parameter) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "../../course_details/get_cmi_values/"+<?php  echo $chaptertake[0]['chapterid'];?>,
                        ...
                        function set_value(cmi_parameter, cmi_value) {
                            ...
                            $.ajax({
                                type: "POST",
                                async: false,
                                url: "../../course_details/set_cmi_values/"+<?php echo $chaptertake[0]['chapterid'];?>,
                                data: cmi_data,
                                dataType: "text",
                                success: function (data) {//alert("in success");
                                    return  data;
                           ...
                           var cmi_data = {'user_slide_activity_details':JSON.stringify(user_slide_activity_details)};
                                $.ajax({
                                    type: "POST",
                                    async: false,
                                    url: "../../course_details/set_user_slide_activity_details/"+<?php echo $chaptertake[0]['chapterid'];?>,
                                    data: cmi_data,
                                    dataType: "text",
                                    success: function (data) {
                                        return  data;
