...
<?php
	...
	echo form_open_multipart('employee/userprofile/'.$this->uri->segment(3).'', $attributes);
	//var_dump($users);	
	?>								
										<div class="col-md-12">
											<div class="widget">
	...
	echo form_open_multipart('employee/pwdchange/'.$this->uri->segment(3).'', $attributes);
	//var_dump($users);	
	?>
