                      ...
                      <div class='form-group'>
                          ...
                          <table style="width: 100%;">
                              ...
                              <tr>
                                  ...
                                  <td><input type="text" class="text_style" name="productinfo" id="productinfo" placeholder="Coupen Code"></td>
                              ...
                              <script type="text/javascript">
                                  $(document).ready(function(){
                                   $('#applyCoupen').click(function() {
                                        ...
                                        $('#DisableDiv').append('<img src="<?php echo base_url();?>images/loading.gif">');
                                        setTimeout(function() { GetData() }, 1000)
                                     });
                                  });
                                     function GetData() {
                                         $('#DisableDiv').html('<p style="color: green;font-size: 1.1em; font-weight: 700;background: cyan;padding: 4px 15px;">Coupen Applied</p>');
                                     }
                              </script>
                              <tr>
