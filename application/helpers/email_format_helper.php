...
function create_csv_user_format($email, $password, $subscription_link,  $company_details) {
    ...
    $message.="<b>Regards,</b>";
    $message .="<br>";
    $message.="<b>".$company_details->name . " Team</b>";
    //  $message.="Dear User,\nPlease click on below URL or paste into your browser to verify your Email Address\n\n http://coolacharya.com/companyadminapp1/verify?user=".$username."&active_link=".sha1($activation_code)."<br>"."\n\nThanks\nAdmin Team";
    return (object) array('message' => $message, 'from_alias' => $from_alias, 'subject' => $subject);
}
...
function create_admin_format($mail_details,$login_link) {
    $activation_code = activation_code();
    $from = 'info@coolacharya.com';
    $from_alias = "Coolacharya  Team";
    $subject = $mail_details['company_name']." Registred  Successfully";
    $message = "Hello ".$mail_details['first_name'];
    $message .="<br>";
    $message .='Glad to have you on CoolAcharya Post Management System';
    $message .="<br>";
    $message .="Follow this link ".$login_link."  to upload your course";
    $message .="<br>";
    $message .="Email: " . $mail_details['email'];
    $message .="<br>";
    $message .="Password: " . $mail_details['password'];
    $message .="<br>";
    $message .='Use the above credentials to login.';
    $message .="<br>";
    //$message.="Dear User,\nPlease click on below URL or paste into your browser to verify your Email Address\n\n http://coolacharya.com/companyadminapp1/verify?user=".$username."&active_link=".sha1($activation_code)."<br>"."\n\nThanks\nAdmin Team";
