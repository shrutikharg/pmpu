...
class Toolbar {
  ...
  _bindListeners() {
    ...
    items.zoomOut.addEventListener('click', function() {alert();
      eventBus.dispatch('zoomout');
    });

    items.pageNumber.addEventListener('click', function() {alert();
      this.select();
    });
    ...
    items.download.addEventListener('click', function() {alert();
