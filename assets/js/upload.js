...
function handleFileSelect(evt) {
   ...
   var is_memmory_available;
       $.ajax({
                                type: "POST",
                                url: "../../admin_company/chapter/check_for_space_availability/",
                                data: {'file_size':files[0].size},
                                async: false,
                                dataType: "json",
                                success: function (data) {
                                   is_memmory_available=data.status; 
                                },
                                error: function () {
                                   // alert('error handing here1');
                                }
                            });if(is_memmory_available=='Success'){
    ...
    var uploader = new MediaUploader({
        ...
        onProgress: function (data) {
            ...
            document.getElementById("file_size").value = data.total;
    ...
    uploader.upload();
                                 ...
                                 var success_url = document.createTextNode("Your available image quota is insufficient to upload this video");
