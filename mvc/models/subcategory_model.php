...
class Subcategory_model extends CI_Model {
    ...
    * @return array
    */
    public function get_subcategory($search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
    ...
    * @return int
    */
    function count_subcategory($search_string=null, $order=null)
    {
		$this->db->select('*');
		$this->db->from('subcategory');
		if($search_string){
