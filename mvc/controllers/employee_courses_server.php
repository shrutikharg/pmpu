...
class Employee_courses extends CI_Controller {
    ...
    * @constant string
    */
    const VIEW_FOLDER = 'employee_company/courses/assigncourses';
    ...
    */
    public function takecourses()
    {
        ...
        echo $empid = $this->uri->segment(4); 
		echo $coursevideoid = $this->uri->segment(5);
		echo $empusername = $this->uri->segment(6);
    ...
    */
    public function update()
    {
        ...
        $data['courses'] = $this->employeecourses_model->get_courses_by_id($id);
        //load the view
        $data['main_content'] = 'employee/courses/edit';
        $this->load->view('includes/template', $data);            
