<?php
class Admin_companygraphreports extends CI_Controller {
    ...
    * @constant string
    */
    const VIEW_FOLDER = 'admin_company/graphreports';
    ...
    */
    public function index()
    {
        ...
        $data['main_content'] = 'admin_company/graphreports/list';
