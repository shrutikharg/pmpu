...
class Admin_coursevideos extends CI_Controller {
    ...
    * @constant string
    */
    const VIEW_FOLDER = 'admin/coursevideos';
    ...
    */
	...
	error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
		...
		$this->load->model('coursevideos_model');
    ...
    */
    public function index()
    {
        ...
        //load the view
        $data['main_content'] = 'admin/coursevideos/list';
    ...
    public function add()
    {
		...
		//$data['courses'] = $this->subcategory_model->get_courses_list();
        //load the view
        $data['main_content'] = 'admin/coursevideos/add';
        $this->load->view('includes/template', $data);  
    }       
    ...
    */
    public function update()
    {
        ...
        //load the view
        $data['main_content'] = 'admin/coursevideos/edit';
        $this->load->view('includes/template', $data);            
