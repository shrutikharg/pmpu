...
class Admin_companycoursesassign extends CI_Controller {
    ...
    */
    ...
    {
     echo 'to get much useful data to see this added hoekj';  
        ...
        $mail->Host       = "md-in-7.webhostbox.net";      // setting GMail as our SMTP server
        $mail->Port       = 465;                   // SMTP port to connect to GMail
        $mail->Username   = "testmail@coolacharya.com";  // user email address
        $mail->Password   = "U7DveSLUDGS5";            // password in GMail
        $mail->SetFrom('mail4prtham@gmail.com', 'Firstname Lastname');  //Who is sending the email
        ...
        $destino = "mail4prtham@gmail.com"; // Who is addressed the email to
	...
	$message ='sdgdgxdg';
			...
			$subject = 'coolacharya.com - Scheduled Topic';
