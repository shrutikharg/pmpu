...
<!--<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/assets/datepicker/schedule_poup.css"/>
<script src="<?php echo base_url(); ?>assets/themes/popupwindow.js"></script>
<script src="<?php echo base_url(); ?>assets/themes/demo.js"></script>--->
...
<?php
//echo count($row['chapterimage']);
if(count($row['chapterimage'])>4)
{
?>

<img src="<?php echo base_url();?>assets/user_documents/<?php echo $row['chapterimage'];?>" >
<?php
}else
{
?>
<img src="<?php echo base_url();?>assets/course_image/default_course.jpg" >
<?php
}
?>
...
?>				 
<!--<a href="../video?course=12&amp;vnum=119621712"><button class="btn btn-primary">Start</button></a>---->
<!---<a data-toggle="modal"  id="" href="#myModal1">
...
<br/><br/>
<a data-toggle="modal" href="#normalModal" id="<?php echo $row['chapterid'] ?>" class="scheduledOn btn btn-schedule" onclick="setModal(<?php echo $row['chapterid'] ?>,<?php echo $row['chaptername'] ?>,<?php echo $row['courseid'] ?>);" >Schedule the chapter</a>
...
<?php
      ...
      echo form_open('employee_company/courses/schedulecoursetime', $attributes);
	  //var_dump($coursetake);
      ?>
...
<div class="col-md-8">
<input type="hidden" name="ChapterId" class="form-control" id="ChapterId" class="ChapterId" readonly="true">
<input type="text" name="ChapterName" class="form-control" class="ChapterName" id="ChapterName" readonly="true">
<input type="hidden" name="CourseId" class="CourseId" id="CourseId" readonly="true">
<input type="hidden" name="ChapterVideo" class="ChapterVideo" id="ChapterVideo" readonly="true">
												</div>
										</div>
										<div class="form-group">
												<label class="col-md-3 control-label">Timezone</label>
												<div class="col-md-8">
													<select id="dTimezone" name="dTimezone" class="form-control">
										...
										<div class="form-group">
											...
											<div class="col-md-8"><input type="text" value="" class="form-control"  name="datetimepick"  id="datetimepicker"/></div>
