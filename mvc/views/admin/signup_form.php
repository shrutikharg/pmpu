...
echo "<p>";
echo form_label('What is your First Name', 'first_name');echo form_input('first_name', set_value('first_name'), 'placeholder="First name"');
echo "</p>";
echo form_input('last_name', set_value('last_name'), 'placeholder="Last name"');

echo form_input('web_address', set_value('web_address'), 'placeholder="Your Web address"');
