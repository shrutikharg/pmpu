...
Name of File:list.php
Date Of Creation:1st Dec 2015
Created By :Shridhar K. Sawant.
Purpose of file:Notifiaction list of the data
...
----->
   <div id="content">
	...
	echo '<div class="column" data-label="cmspagelink1">'.$row['cmspagelink1'].'</div>';  
		...
		{
				echo '<div class="column" data-label="action">
                  <a href="'.site_url("admin_company").'/cmspage/update/'.$row['id'].'" class="btn btn-info" disabled>view & edit</a></div>'; 
		}			
                echo '</div>';
