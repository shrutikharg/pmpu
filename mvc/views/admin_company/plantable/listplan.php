...
<div id="standard" <?php if($planidusers =='1'){ echo 'class="standard_current"'; }else{ echo 'class="standard"';}?>>
...
<h3><span class="rupee_style">R</span>0.00</h3>
		...
		<div class="pricing cell">
			...
			<div <?php if($planidusers =='2'){ echo 'class="primegreen"'; }else{ echo 'class="prime"';}?> id="pro">
		...
		<div class="pricing cell bottom">
			...
			<div <?php if($planidusers =='3'){ echo 'class="standard_current"'; }else{ echo 'class="standard"';}?> id="enterprise">
		...
		<div class="pricing cell">
			...
			<div  <?php if($planidusers =='4'){ echo 'class="primegreen"'; }else{ echo 'class="prime"';}?> id="pro">
