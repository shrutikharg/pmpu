    <div class="container top">
      ...
      <div class="page-header users-header">
		...
		{				
		?>
		<a  href="<?php echo site_url("admin_company").'/'.$this->uri->segment(2); ?>/add" class="btn btn-success">Add a new</a>
        </h2>
		 <?php
		}
		?>
            ...
            <tbody>
              ...
              foreach($userassign as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin_company").'/userassign/update/'.$row['id'].'" class="btn btn-info">view & edit</a></td>';  
                echo '</tr>';
              }
              ?>      
            </tbody>
