...
<div class="container">
				...
				<div class="page-header">
					<div class="page-title">
						<h3><?php echo $users[0]['first_name'].' '.$users[0]['last_name']; ?> Profile</h3>
					</div>
...
<?php
	...
	echo form_open_multipart('admin_company/employeeprofile/'.$this->uri->segment(3).'', $attributes);
	if($this->session->flashdata('flash_message')){
        if($this->session->flashdata('flash_message') == 'updated')
        {
          echo '<div class="alert alert-success">';
            echo '<a class="close" data-dismiss="alert">×</a>';
            echo '<strong>Well done!</strong> Employee details updated with success.';
          echo '</div>';       
        }else{
	...
	echo form_open_multipart('admin_company/emppwdchange/'.$this->uri->segment(3).'', $attributes);
	//var_dump($users);	
	?>
