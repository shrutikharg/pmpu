...
<head>
	...
	<!--=== CSS ===-->
	<!-- Bootstrap -->
	<link href="<?php echo base_url(); ?>assets/bootstrap/css/video_bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css" />
  ...
  //var_dump($this->session->userdata);
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/css/videolayout.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/css/tablayout.css">
...
<body>
	...
	<header class="header navbar navbar-fixed-top" role="banner">
		...
		<div class="container">
			...
			<!-- Logo -->
			<a class="navbar-brand" href="<?php echo base_url(); ?>employee_company/courses">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				Uploaded new details on server with footer integration on every themes
				WOrked on adding chapter under the courses where he can  add chapter details
				...
				<li class="dropdown user">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<i class="icon-male"></i>
						<span class="username"><?php echo $this->session->userdata('empuser_name')	?></span>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/vimeo.ga.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/vimeo.ga.min.js"></script>
