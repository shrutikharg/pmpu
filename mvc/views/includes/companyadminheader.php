...
<body>
	...
	<?php
		...
		<img src="<?php echo base_url(); ?>assets/user_theme/<?php echo 'modelcam-plain.jpg'; ?>"  alt="company_logo"  />
	...
	if($planid_currentuser==='1')
				...
				<ul id="nav">
					<li class="disable_menu" >
						...
						<ul class="sub-menu">
							<li <?php if($this->uri->segment(2) == 'category'){ echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								Departments List
								</a>
							</li>
							<li <?php if($this->uri->segment(2) == 'subcategory'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
...
<li <?php if($this->uri->segment(3) == 'schedulecourse'){echo 'class="current_menu"';}?>>
					...
					<li class="disable_menu" disabled> 
						<a>
							<i class="icon-supportmail"></i>
							Mail Support
						</a>
						<ul class="sub-menu">
							<li <?php if($this->uri->segment(2) == 'supportmail'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								  Contact Support
								</a>
					...
					<li class="disable_menu" disabled>
						...
						<ul class="sub-menu">
							<li <?php if($this->uri->segment(2) == 'employeelist'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								 Employee Users List
								</a>
					...
					<li class="disable_menu" disabled>
						...
						<ul class="sub-menu" >
							<li <?php if($this->uri->segment(2) == 'brandings'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								Theme Updation 
								</a>
					...
					<li class="disable_menu" disabled>
						...
						<ul class="sub-menu">
							<li <?php if($this->uri->segment(2) == 'analytics'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								Chapter list
								</a>
							</li>
							<li <?php if($this->uri->segment(2) == 'graphreports'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								Graph Report
								</a>
					...
					<!--<li <?php if($this->uri->segment(2) == 'analyreports'){echo 'class="disable_menu"';}?>>
							...
							<li <?php if($this->uri->segment(2) == 'analyticreports'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								Analytics
								</a>
							...
							<!-- <li <?php if($this->uri->segment(2) == 'analyticsgraph'){echo 'class="disable_menu"';}?>>
					...
					<li class="disable_menu">
						...
						<ul class="sub-menu">
			<li <?php if($this->uri->segment(2) == 'cmspage'){echo 'class="disable_menu"';}?>>
								<a href="#">
								<i class="icon-angle-right"></i>
								  Setting CMS Page
								</a>
					...
					<li <?php if(($this->uri->segment(2) == 'plantable')){echo 'class="current open"';}?>>
						...
						<ul class="sub-menu">
			<li <?php if($this->uri->segment(2) == 'plantable'){echo 'class="disable_menu"';}?>>
					...
					<li class="disable_menu">
						...
						<ul class="sub-menu">
			<li <?php if($this->uri->segment(2) == 'commenting'){echo 'class="disable_menu"';}?>>
							<a href="#">
								<i class="icon-angle-right"></i>
									View Comments
								</a>
					...
					<li <?php if(($this->uri->segment(2) == 'add_question_bank') || ($this->uri->segment(2) == 'add_question')){echo 'class="current open"';}?>>
						...
						<ul class="sub-menu">
							<li <?php if($this->uri->segment(2) == 'add_question_bank'){echo 'class="current_menu"';}?>>
								<a href="<?php echo base_url(); ?>admin_company/add_question_bank">
								<i class="icon-angle-right"></i>
								 Add question bank
								</a>
							</li>
							 <li <?php if($this->uri->segment(2) == 'add_question'){echo 'class="current_menu"';}?>>
								...
								<i class="icon-angle-right"></i>
								  Add Question
                                        ...
                                        <li <?php if(($this->uri->segment(2) == 'add_quiz') ){echo 'class="current open"';}?>>
						<a href="javascript:void(0);" >
							<i class="icon-facetime-video"></i>
							Quiz
						</a>
						<ul class="sub-menu">
							<li <?php if($this->uri->segment(2) == 'add_qquiz'){echo 'class="current_menu"';}?>>
								<a href="<?php echo base_url(); ?>admin_company/add_quiz">
								<i class="icon-angle-right"></i>
								 Add question bank
								</a>
							</li>
