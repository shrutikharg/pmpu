...
class CI_Email {
	...
	var	$smtp_host		= "mail.coolacharya.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@coolacharya.com";		// SMTP Username
	var	$smtp_pass		= "info@123";		// SMTP Password
